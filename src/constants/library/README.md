...
* [Bankstats Tables](https://www.bankofengland.co.uk/statistics/Tables)
  * A8.1.csv
  * C1.2.csv
* [Companies House Constants](https://github.com/companieshouse/api-enumerations/blob/master/constants.yml)
  * codes.csv: The intersection of **SIC (standard industrial classification) codes of constants** & [SIC 2007](https://www.ons.gov.uk/methodology/classificationsandstandards/ukstandardindustrialclassificationofeconomicactivities/uksic2007)
